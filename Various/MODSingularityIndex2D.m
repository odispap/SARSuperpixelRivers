% MODIFIED
% As per Isikdogan 2015 to use a scale-specific debiasing filter 
% F. Isikdogan, A. C. Bovik, P. Passalacqua, "Automatic channel network
% extraction from remotely sensed images by singularity analysis", IEEE 
% Geoscience And Remote Sensing Letters, 11:12, pp. 2218-2221, 2015
% 
% Oct. 2019
% O. Pappas
...
for scale = nrScales : -1 : 1
    ...
    sigmacurr = ceil(sqrt((1-(0.2)^2)/(0.2^2))*nrScales);
    gcurr = fspecial('gaussian',siz,sigmacurr);
    mu = conv2d_fft(I1, gcurr);
    I = I1 - mu;
